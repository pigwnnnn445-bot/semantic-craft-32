    ...
    benefits: {
      comparison: {
        ...
        products: [
          ...
          { name: "Sora 2", company: "" },
          { name: "Veo 3.1", company: "" },
        ],
        rows: [
          { feature: "Input Types", values: ["Text, images, audio, video", "Text, image", "Text input, with text-to-video and image-to-video support"] },
          { feature: "Native Audio", values: ["Yes", "Yes", "Yes"] },
  ...
  zh: {
    ...
    benefits: {
      comparison: {
        ...
        rows: [
          { feature: "输入类型", values: ["文本、图片、音频、视频", "文本、图片", "文本输入，支持文本生视频与图生视频"] },
          { feature: "原生音频", values: ["支持原生音频", "支持原生音频", "支持原生音频"] },
